        ...
        <div class="col-md-6">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('sub-category.update', $sub_categories->id) }}" method="POST">
                        @csrf
                                ...
                                <select name="category_id"
                                    class="form-select @error('category_id') is-invalid @enderror" required>
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" @if ($category->id == $sub_categories->category_id) selected @endif
                        ...
                        <div class="mb-3">
                            ...
                            <input 
                                ...
                                value="{{ old('category_name', $sub_categories->sub_category_name) }}"
