                            ...
                            <div class="app-content mt-3">
                                ...
                                <div class="card shadow-sm">
                                    ...
                                    <div class="card-header d-flex align-items-center">
                                        <h5 class="mb-0 fw-semibold">Sub Category List</h5>

                                        <a href="{{ route('sub-category.create') }}" class="btn btn-success btn-sm ms-auto">
                                    ...
                                    <div class="card-body" style="vw:100">
                                        ...
                                        <div class="table-responsive">
                                            <table id="categoryTable" class="table table-bordered table-striped w-100">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex gap-2">
                                                                    ...
                                                                    <a href="{{ route('sub-category.show', $row->id) }}"
                                                                        class="btn btn-sm btn-primary">
                                                                        View
                                                                    </a>

                                                                    <a href="{{ route('sub-category.edit', $row->id) }}"
                                                                        class="btn btn-sm btn-warning">
                                                                        Edit
                                                                    </a>

                                                                    <form action="{{ route('sub-category.destroy', $row->id) }}"
